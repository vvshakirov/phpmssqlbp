...
1. Install buildpack-packager
    ...
    ```bash
    (cd src/php/vendor/github.com/cloudfoundry/libbuildpack/packager/buildpack-packager && go install)
    ```
...
Inspired by the [Heroku buildpack](https://github.com/heroku/heroku-buildpack-php).
